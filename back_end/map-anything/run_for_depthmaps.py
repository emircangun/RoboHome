...
images = "/cluster/home/idemir/weekend_building/7_data"  # or ["path/to/img1.jpg", "path/to/img2.jpg", ...]
...
for i, pred in enumerate(predictions):
    ...
    print(f"View {i}: pts3d shape: {pts3d.shape}, depth_z shape: {depth_z.shape}, intrinsics: {intrinsics[0]}")
    print(f"View {i}: min max depth_z: {depth_z.min().item()} {depth_z.max().item()}")
